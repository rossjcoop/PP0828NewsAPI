...
class App extends Component {
  ...
  componentDidMount() {
  let url = "https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=58c4109d145f4e78bee5913236b7678b"
...
render() {
  return (
    <div className="App row">
      ...
      <Feed onClick={this.randomizer} randomFeed={this.state.randomFeed} loader={this.state.loader} />
